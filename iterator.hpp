...
template <class T>
	...
	class reverse_iterator {
		...
		public:
			...
			operator reverse_iterator<const iterator_type>() const 		{ return reverse_iterator<const iterator_type>(_value); }
			...
			template <class Iter>
			difference_type operator-(const reverse_iterator<Iter>& x)	{ return x.base() - _value; }
